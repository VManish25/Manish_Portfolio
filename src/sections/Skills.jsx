...
import { Database, Layout, Server, Settings, Terminal, Cloud, Webhook } from 'lucide-react';
  ...
  return (
    <section id="skills" className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-foreground sm:text-4xl tracking-tight">Technical Skills</h2>
          <p className="text-muted-foreground mt-2 text-base">Technologies, platforms, and engineering tools I work with across the full stack.</p>
        </div>
